...
struct
  ...
  datatype heap = ::: of elem * heap segm list
   ...
   *  head and tail, and then the tail into a prefix and a suffix.
   *)
  ...
  (*  PHASE 3:  Extract prefixes of equal lengths from both suffixes, until one
   *  suffix dies (i.e., becomes empty).
   *)
  ...
  (*  PHASE 4:  Move everything back into the surviving suffix.  *)
  fun NONE @ xs = xs
